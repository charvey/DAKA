...
public class Parameters
{
	...
	public String toString()
	{
		...
		DefaultStringifier<Map<String, String>> mapStringifier = new DefaultStringifier<Map<String, String>>(
				conf, GenericsUtil.getClass(params));
		try
		{
		...
		{
			log.info(
					"Encountered IOException while deserializing returning empty string",
					e);
			return "";
		}
	...
	public static Map<String, String> parseParams(String serializedString)
			throws IOException
	{
		Configuration conf = new Configuration();
		conf.set(
