...
/**
 * A in FPGrowth is a list of items (here int) and the support(the number of
 * times the pattern is seen in the dataset)
 * 
 */
public class Pattern implements Comparable<Pattern>
{
	...
	public final void add(int id, long supportCount)
	{
		...
		this.support = supportCount > this.support ? this.support
				: supportCount;
	}
