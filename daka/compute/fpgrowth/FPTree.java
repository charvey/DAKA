...
/**
 * The Frequent Pattern Tree data structure used for mining patterns using
 *  FPGrowth algorithm
 * 
 */
public class FPTree
{
	...
	public final int[] getHeaderTableAttributes()
	{
		...
		System.arraycopy(headerTableAttributes, 0, attributes, 0,
				headerTableCount);
		return attributes;
	}
	...
	public void replaceChild(int parentNodeId, int replacableNode,
			int childnodeId)
	{
	...
	private void resizeHeaderTable()
	{
		...
		System.arraycopy(oldAttributes, 0, this.headerTableAttributes, 0,
				headerTableCount);
		System.arraycopy(oldAttributeCount, 0, this.headerTableAttributeCount,
				0, headerTableCount);
