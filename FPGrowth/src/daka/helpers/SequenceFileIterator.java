...
/**
 * <p>
 * {@link java.util.Iterator} over a {@link SequenceFile}'s keys and values, as
 * a {@link Pair} containing key and value.
 * </p>
 */
		...
		extends AbstractIterator<Pair<K, V>> implements Closeable
{
	...
	private static final Logger log = LoggerFactory
			.getLogger(SequenceFileIterator.class);
	...
	public SequenceFileIterator(Path path, boolean reuseKeyValueInstances,
